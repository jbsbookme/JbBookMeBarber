  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-cyan-500">Cargando reseñas...</div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="border-b border-gray-800">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-gray-400">Lo que dicen nuestros clientes</p>
        </div>
      </div>
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">{stats.total} reseñas</p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          {reviews.length === 0 ? (
            <Card className="bg-gray-900 border-gray-800 p-8 text-center">
              <p className="text-gray-400">No hay reseñas disponibles aún</p>
            </Card>
          ) : (
            reviews.map((review) => (
                      ...
                      <div className="mt-4 pl-4 border-l-2 border-[#00f0ff]/30 bg-[#00f0ff]/5 p-4 rounded-r-lg">
                        ...
                        {review.adminRespondedAt && (
                          <p className="text-xs text-gray-500 mt-2">
                            {format(new Date(review.adminRespondedAt), 'dd MMM yyyy', { locale: es })}
                          </p>
                        )}
                      </div>
                    )}
