          ...
          <CardContent className="p-4">
            <div className="flex gap-3">
              <Button
                ...
                className={filter === 'ALL' ? 'bg-[#00f0ff] text-black' : 'text-white border-gray-700'}
              >
                Todas
              </Button>
              <Button
                ...
                className={filter === 'BARBER_PAYMENT' ? 'bg-purple-600 text-white' : 'text-white border-gray-700'}
              >
                Pagos de Barberos
              </Button>
              <Button
                ...
                className={filter === 'CLIENT_SERVICE' ? 'bg-blue-600 text-white' : 'text-white border-gray-700'}
              >
