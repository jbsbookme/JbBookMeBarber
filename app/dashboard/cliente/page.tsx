...
import { Camera, Calendar, Clock, Lock, Mail, User, ArrowLeft } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400">Gestiona tu información y citas</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-1 bg-gray-900 border-gray-800">
            <CardHeader>
              <CardTitle className="text-[#00f0ff]">Información Personal</CardTitle>
            </CardHeader>
            ...
            {appointments.length === 0 ? (
              ...
              <div className="space-y-4">
                {appointments.map((appointment) => (
                  <div
                    key={appointment.id}
                    className="flex items-center gap-4 p-4 bg-gray-800 rounded-lg border border-gray-700 hover:border-[#00f0ff] transition-colors"
                  >
                    {/* Barber Avatar */}
                    <Avatar className="w-12 h-12">
                      <AvatarImage src={appointment.barber?.user?.image || undefined} />
