...
type Step = 'services' | 'barbers' | 'barber-profile' | 'datetime' | 'payment';
...
export default function ReservarPage() {
  ...
  const renderBarberProfileStep = () => {
    ...
    const photos = selectedBarber.media.filter((m) => m.type === 'IMAGE');
    const videos = selectedBarber.media.filter((m) => m.type === 'VIDEO');
              ...
              {selectedBarber.phone && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-white">{selectedBarber.phone}</p>
                  </div>
                </a>
              )}
    ...
    <div className="min-h-screen bg-black pb-20 pt-8">
      ...
      <div className="container mx-auto px-4 mb-8">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          {['services', 'barbers', 'barber-profile', 'datetime', 'payment'].map((step, index) => (
            <div
              key={step}
              className={`h-2 rounded-full transition-all duration-300 ${
                currentStep === step
                  ...
                  : index <
                    ['services', 'barbers', 'barber-profile', 'datetime', 'payment'].indexOf(currentStep)
                  ? 'w-8 bg-[#00f0ff]'
                  : 'w-8 bg-gray-700'
              }`}
            />
