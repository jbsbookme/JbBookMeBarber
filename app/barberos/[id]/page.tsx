...
import { Scissors, ArrowLeft, Star, Calendar, Clock, DollarSign, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-gray-400">
                      ({barber.reviews.length} {barber.reviews.length === 1 ? 'reseña' : 'reseñas'})
                    </span>
                    {barber.hourlyRate && (
                      <span className="text-[#00f0ff] font-semibold ml-auto">
                        ${barber.hourlyRate}/hora
                      </span>
                    )}
                  </div>
        ...
        {/* Reviews */}
        <div>
          <h2 className="text-3xl font-bold text-white mb-6">Reseñas</h2>
