...
export function Footer() {
  ...
  // Ocultar footer en páginas de dashboard y auth
  const hiddenRoutes = ['/dashboard', '/auth', '/login', '/registro', '/bienvenida'];
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">
              <span className="text-[#00f0ff]">Barbería</span>{' '}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center text-gray-400 text-sm">
                ...
                <a href="mailto:info@barberiapremium.com" className="hover:text-[#00f0ff] transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-gray-500 text-sm text-center md:text-left">
            © {currentYear} Barbería Premium. Todos los derechos reservados.
          </p>
